...
export class NotificationService{
    ...
    getCategoryNotifications(category:Category): Observable<Notification[]>{
    ...
    addNotification(data: { ntf_textContent: string , user_ID : number,ntf_categoryID:number , ntf_imgName?:string }): Observable<Notification>{
